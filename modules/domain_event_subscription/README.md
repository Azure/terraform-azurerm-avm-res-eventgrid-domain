...
### <a name="input_event_grid_domain_resource_id"></a> [event\_grid\_domain\_resource\_id](#input\_event\_grid\_domain\_resource\_id)

Description: The resource ID of the Event Grid Domain to create the subscription on.  
